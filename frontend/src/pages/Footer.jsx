...
import { useState, useRef, useEffect } from "react"; // Potrzebne hooki
    ...
    return (
        <footer className="footer" ref={footerRef}>
            <div className="footer-container">
                <div
                    className={`footer-section left ${isVisible ? "is-visible" : ""}`}
                    style={{ transitionDelay: "100ms" }}
                >
                    <img src="/images/logo.png" alt="Logo" className="footer-logo" />
                    <p>
                        Turniej e-sportowy Rocket League z pulą nagród 20 000 zł. <span className="footer-cta-text">Dołącz i pokaż, co potrafisz!</span>
                    </p>
                </div>

                <div
                    className={`footer-section center ${isVisible ? "is-visible" : ""}`}
                ...
                <div
                    className={`footer-section right ${isVisible ? "is-visible" : ""}`}
                ...
                >
                    ...
                    <div className="social-icons">
                        ...
                        <a href="https://twitch.tv" target="_blank" rel="noreferrer" aria-label="Twitch">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Twitch</title><path fill="currentColor" d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z" /></svg>
                        </a>
